...
function Swap({ address, isConnected }) {
    ...
    function changeAmount(e) {
        ...
        if (e.target.value && prices) setTokenTwoAmount((e.target.value * prices.ratio).toFixed(2))
            ...
            <div className='tradeBox'>
                ...
                <div className='inputs'>
                    ...
                    <div className='assetOne' onClick={() => openModal(1)}>
                        <img src={tokenOne.img} alt="asssetOneLogo" className='assetLogo' />
                        {tokenOne.ticker}
                        <DownOutlined />
                    </div>
                    <div className='assetTwo' onClick={() => openModal(2)}>
                        <img src={tokenTwo.img} alt="asssetOneLogo" className='assetLogo' />
                        {tokenTwo.ticker}
                        <DownOutlined />
                    </div>
                </div>
